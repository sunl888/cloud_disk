...
func LoadFileIds(ctx context.Context, folderIds []int64, userId int64) (folderFiles []*model.FolderFile, err error) {
	return FromContext(ctx).LoadFileIds(folderIds, userId)
}
