...
func LoadFolderFilesByFolderIds(ctx context.Context, folderIds []int64, userId int64) (folderFiles []*model.FolderFile, err error) {
	return FromContext(ctx).LoadFolderFilesByFolderIds(folderIds, userId)
}

func LoadFolderFilesByFolderIdAndFileIds(ctx context.Context, folderId int64, fileIds []int64, userId int64) (folderFiles []*model.FolderFile, err error) {
